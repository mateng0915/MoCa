...
+ (void)showErrorWithStatus:(NSString*)status duration:(CGFloat)duration {
    [[self sharedView] showImage:[self sharedView].errorImage status:status duration:duration];
}
