...
NSString *const MJRefreshHeaderIdleText = @"pull down update";
NSString *const MJRefreshHeaderPullingText = @"latest update retrieved";
NSString *const MJRefreshHeaderRefreshingText = @"updating...";

NSString *const MJRefreshAutoFooterIdleText = @"pull up load more";
NSString *const MJRefreshAutoFooterRefreshingText = @"loading...";
NSString *const MJRefreshAutoFooterNoMoreDataText = @"no more";

NSString *const MJRefreshBackFooterIdleText = @"pull up load more";
...
NSString *const MJRefreshBackFooterNoMoreDataText = @"no more";
