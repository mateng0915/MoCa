...
#import "SetNotificationTVC.h"
#import "ServiceMyProfile.h"

@implementation SetNotificationTVC

- (void)viewDidLoad {
    [super viewDidLoad];
    self.header.text = @"Notification Setting";
    self.tableView.rowHeight = UITableViewAutomaticDimension;
    self.tableView.estimatedRowHeight = 60.0;
    
    self.lblRow0.text = @"Notify me when my comments are being replied";
    self.lblRow1.text = @"Notify me when someone follows me";
    self.lblRow2.text = @"Notify me when someone replies under the event I host";
    ...
    self.idx = user.notify.integerValue;
    [self updateImg];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [ServiceMyProfile systemConfigRrecommend:0 notify:self.idx receive:0 success:^{
        ...
        [M_UserDefault setValue:@(self.idx) forKey:SystemConfigNotify];
